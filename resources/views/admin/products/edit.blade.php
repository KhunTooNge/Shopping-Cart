                    ...
                    <form action="{{ route('product#update') }}" method="post" novalidate="novalidate"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="productName" name="productName"
                                        value="{{ old('productName', $product->name) }}" type="text"
                                        class="form-control
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="productPrice" name="productPrice"
                                        value="{{ old('productPrice', $product->price) }}" type="number"
                                        class="form-control
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    @enderror "
                                        ...
                                        @foreach ($category as $c)
                                            <option value="{{ $c->id }}"
                                                @if ($product->category_id == $c->id) selected @endif>{{ $c->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-8">
                                <div class="form-group">
                                    ...
                                    <input id="waitTime" name="waitTime"
                                        value="{{ old('waitTime', $product->waiting_time) }}" type="number"
                                        class="form-control
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="" cols="30" rows="4"
                                ...
                                @enderror"
                                aria-required="true" aria-invalid="false">{{ old('description', $product->description) }}</textarea>
                        ...
                        <div>
                            <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                ...
                                <span id="payment-button-amount">Update Products </span>
                            </button>
                        </div>
